...
public class DeviceConnector {
 ...
 public static final int STATE_NONE = 0;       // we're doing nothing
    ...
    private synchronized void setState(int state) {
        ...
        mState = state;
        mHandler.obtainMessage(com.example.gurjap.mapfouroct.DeviceControlActivity.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket) {
       ...
       if (mConnectThread != null) {
        ...
        Message msg = mHandler.obtainMessage(com.example.gurjap.mapfouroct.DeviceControlActivity.MESSAGE_DEVICE_NAME, deviceName);
    ...
    private void connectionFailed() {
       ...
       Message msg = mHandler.obtainMessage(com.example.gurjap.mapfouroct.DeviceControlActivity.MESSAGE_TOAST);
    ...
    private class ConnectedThread extends Thread {
            ...
            while (true) {
                try {
                    ...
                    if (readed.contains(answerEndingFlag)) {
                        mHandler.obtainMessage(com.example.gurjap.mapfouroct.DeviceControlActivity.MESSAGE_READ, bytes, -1, readMessage.toString()).sendToTarget();
        ...
        public void writeData(byte[] chunk) {
            ...
            try {
                ...
                mHandler.obtainMessage(com.example.gurjap.mapfouroct.DeviceControlActivity.MESSAGE_WRITE, -1, -1, chunk).sendToTarget();
            } catch (IOException e) {
        ...
        public void write(byte command) {
            ...
            try {
                ...
                // Share the sent message back to the UI Activity
                mHandler.obtainMessage(com.example.gurjap.mapfouroct.DeviceControlActivity.MESSAGE_WRITE, -1, -1, buffer).sendToTarget();
            } catch (IOException e) {
                if (D) Log.e(TAG, "Exception during write", e);
            }
        }
